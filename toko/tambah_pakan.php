...
<div class="content">
  <header>  
  <h1 style="text-align: center;">Data/Jenis Pakan</h1>
  ...
  <center>
<div class="box">
        <h2 style="text-align: center;margin-top: 30px; margin-bottom: 25px">Tambah Pakan</h2>
        <table border="1" cellspacing="8" border="1" widht="100%" style="text-align: center; font-size: 15px; margin-bottom: 20px; color: black;">
        <form action="proses.php?aksi=tambahpakan" method="POST">
            <tr>
                <td>Nama Pakan : </td>
                <td><input type="text" name="nama_pakan"></td>
            </tr>
            <tr>
                <td>Berat Bersih : </td>
                <td><input type="text" name="berat_bersih"></td>
            </tr>
            <td>Harga Pakan : </td>
